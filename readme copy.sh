...
rclone copy  gdrive_yzj:R1/pi0_checkpoints/pine_new/pi05_pour_48_0226zaijia/10000 /home/pine/yzj/RoboTwin/policy/pi0/checkpoint/pi05_pour_48_0226zaijia/10000 -P # 待测
rclone copy  gdrive_yzj:R1/pi0_checkpoints/pine_new/pi05_pour_48_0226zaijia/5000 /home/pine/yzj/RoboTwin/policy/pi0/checkpoint/pi05_pour_48_0226zaijia/5000 -P # 待测
rclone copy  gdrive_yzj:R1/pi0_checkpoints/pine_new/pi05_pour_48_0226zaijia/20000 /home/pine/yzj/RoboTwin/policy/pi0/checkpoint/pi05_pour_48_0226zaijia/20000 -P # 待测
...
rclone copy  gdrive_yzj:R1/pi0_checkpoints/pine_new/pour_humandata_48_0226zaijia/29999 /home/pine/yzj/RoboTwin/policy/pi0/checkpoint/pour_humandata_48_0226zaijia/29999 -P # 直接retarget 
rclone copy  gdrive_yzj:R1/pi0_checkpoints/nsccp/pi05-anygrasp_zaijia_0330human/29999 /home/pine/yzj/RoboTwin/policy/pi0/checkpoint/pi05-anygrasp_zaijia_0330human/29999 -P # anygrasp结果效果不好
rclone copy  gdrive_yzj:R1/pi0_checkpoints/nsccp/pi05-anygrasp_zaijia_0406human-26/29999 /home/pine/yzj/RoboTwin/policy/pi0/checkpoint/pi05-anygrasp_zaijia_0406human-26/29999 -P # 



rclone copy /home/pine/yzj/hand/ gdrive_yzj:R1/hand/ -P --transfers 8 --checkers 16 --dry-run
rclone copy /home/pine/yzj/src/videos gdrive_yzj:R1/pi0_result/pi05 -P --transfers 16 --checkers 16 --dry-run
rclone copy /home/pine/yzj/hand/ gdrive_yzj:R1/hand/ -P --transfers 16 --checkers 16 --dry-run
...
# [pi05]2/2 300000 杯子需要扶着其他完美 76 77 78.mp4错误
# 90(0.6) 91(0.4) 92(0.4) 93(0.4) 94(0.6) 95(0.5) 96(0.2) 97y(0.5) 98g(0.5) 111g(0.9) 116g(0.5) 117(0.5) 118(0.99) 0/10
cd /home/pine/yzj/openpi
XLA_PYTHON_CLIENT_MEM_FRACTION=0.6 uv run scripts/serve_policy.py \
  policy:checkpoint \
  --policy.config pi05_zaijia_0215 \
...
# [pi05]10000 0/2 不太行，抓取的姿势和我采的数据不一样 69 70.mp4
cd /home/pine/yzj/openpi
XLA_PYTHON_CLIENT_MEM_FRACTION=0.6 uv run scripts/serve_policy.py \
  policy:checkpoint \
  --policy.config pi05_zaijia_0215 \
  --policy.dir /home/pine/yzj/RoboTwin/policy/pi0/checkpoint/pi05_pour_48_0226zaijia/10000

# [pi05] 5000 step 0/2 不太行，抓取的姿势和我采的数据不一样 72.mp4 73.mp4 
cd /home/pine/yzj/openpi
XLA_PYTHON_CLIENT_MEM_FRACTION=0.6 uv run scripts/serve_policy.py \
  policy:checkpoint \
  --policy.config pi05_zaijia_0215 \
  --policy.dir /home/pine/yzj/RoboTwin/policy/pi0/checkpoint/pi05_pour_48_0226zaijia/5000


# 【baseline】人手（54） + 48机器人
# 113g(0.5) 114(0) 125(换位置)0/1
cd /home/pine/yzj/openpi
XLA_PYTHON_CLIENT_MEM_FRACTION=0.6 uv run scripts/serve_policy.py \
  policy:checkpoint \
  --policy.config pi05_zaijia_0215 \
  --policy.dir /home/pine/yzj/RoboTwin/policy/pi0/checkpoint/pour_humandata_48_0226zaijia/29999



# /home/pine/yzj/RoboTwin/policy/pi0/checkpoint/pi05-anygrasp_zaijia_0330human/29999 
# 【anygrasp】人手（27） + 48机器人
cd /home/pine/yzj/openpi
XLA_PYTHON_CLIENT_MEM_FRACTION=0.6 uv run scripts/serve_policy.py \
  policy:checkpoint \
  --policy.config pi05_zaijia_0215 \
  --policy.dir /home/pine/yzj/RoboTwin/policy/pi0/checkpoint/pi05-anygrasp_zaijia_0330human/29999 




# 【anygrasp】人手（26） + 48机器人 0406
# 0.5 夹到cuo但是没有成功倒水
# 100（0.7) 101(0.5) 102y（0.3）（0.5）103y(0.8) 104(1) 105(0.6) 106(0.6) 107(0.5) 108(0.9) 109(0.9) 120(0.4) 121(0.8) 1/9
cd /home/pine/yzj/openpi
XLA_PYTHON_CLIENT_MEM_FRACTION=0.6 uv run scripts/serve_policy.py \
  policy:checkpoint \
  --policy.config pi05_zaijia_0215 \
  --policy.dir /home/pine/yzj/RoboTwin/policy/pi0/checkpoint/pi05-anygrasp_zaijia_0406human-26/29999 
...
source /home/pine/yzj/openpi/.venv/bin/activate
...
python deploy_pi0_1030.py --task_prompt "Pfick up the starfruit and the apple, then place them on the plate." --n_iterations 200 --init_type 2 # 竖直
# 必须
conda deactivate
# 2. 临时将 CUDA 12.1 设为当前终端的首选编译器
export CUDA_HOME=/usr/local/cuda-12.1
